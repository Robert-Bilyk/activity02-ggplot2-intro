...
The boplot easily lets you see the mean and any major outliers in the dataset. Jitterplots do not easily let you see this information however, it does let you better view patterns in each variable.
